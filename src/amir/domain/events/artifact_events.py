...
class ArtifactProduced(DomainEvent):
    ...
    @classmethod
    def create(cls, artifact_id: UUID, task_id: UUID, contract_type: str, correlation_id: UUID) -> "ArtifactProduced":
        return cls(
...
class ArtifactValidated(DomainEvent):
    ...
    @classmethod
    def create(
        cls, artifact_id: UUID, valid: bool, errors: list[str] = None, correlation_id: UUID = None
    ) -> "ArtifactValidated":
        return cls(
            aggregate_id=artifact_id,
            aggregate_type="Artifact",
...
class ArtifactAccepted(DomainEvent):
    ...
    @classmethod
    def create(cls, artifact_id: UUID, correlation_id: UUID = None) -> "ArtifactAccepted":
        return cls(
            aggregate_id=artifact_id,
            aggregate_type="Artifact",
            payload={},
...
class ArtifactRejected(DomainEvent):
    ...
    @classmethod
    def create(cls, artifact_id: UUID, errors: list[str], correlation_id: UUID = None) -> "ArtifactRejected":
        return cls(
            aggregate_id=artifact_id,
            aggregate_type="Artifact",
