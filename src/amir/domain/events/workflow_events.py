...
class WorkflowCreated(DomainEvent):
    ...
    @classmethod
    def create(
        cls, workflow_id: UUID, team_id: UUID, template_id: UUID, correlation_id: UUID = None
    ) -> "WorkflowCreated":
        return cls(
...
class WorkflowTransitioned(DomainEvent):
    ...
    @classmethod
    def create(cls, workflow_id: UUID, from_state: str, to_state: str, correlation_id: UUID) -> "WorkflowTransitioned":
        return cls(
            aggregate_id=workflow_id,
            aggregate_type="WorkflowInstance",
            payload={
...
class WorkflowCompleted(DomainEvent):
    ...
    @classmethod
    def create(cls, workflow_id: UUID, correlation_id: UUID = None) -> "WorkflowCompleted":
        return cls(
            aggregate_id=workflow_id,
            aggregate_type="WorkflowInstance",
            payload={},
...
class WorkflowFailed(DomainEvent):
    ...
    @classmethod
    def create(cls, workflow_id: UUID, error: str, correlation_id: UUID = None) -> "WorkflowFailed":
        return cls(
            aggregate_id=workflow_id,
            aggregate_type="WorkflowInstance",
            payload={"error": error},
